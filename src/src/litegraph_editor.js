...
import iconGrid from './imgs/grid.png';
import iconLoad from './imgs/icon-load.png';
import iconSave from './imgs/icon-play.png';
...
export default class Editor {
    ...
    constructor(container_id, options) {
        ...
        graphcanvas.background_image = iconGrid;
        ...
        //add stuff
        this.addToolsButton("loadsession_button","ReLoad",iconLoad, this.onLoadButton.bind(this), ".tools-left" );
        this.addToolsButton("savesession_button","Save",iconSave, this.onSaveButton.bind(this), ".tools-left" );
        this.addToolsButton("savesession_button","Build",iconSave, this.onBuildButton.bind(this), ".tools-left" );

        this.onLoadHandle = function(){};
        this.onSaveHandle = function(){};
        this.onBuildHandle = function(){};
    ...
    addToolsButton = function (id, name, icon_url, callback, container) {
        if (!container) {
            container = ".tools";
        }
    ...
    createButton = function (name, icon_url, callback) {
    ...
    onSaveButton = function () { 
        if(this.onSaveHandle != undefined){

            this.onSaveHandle(this);
        }
    };

    onBuildButton = function(){
        if(this.onBuildHandle != undefined){
            this.onBuildHandle(this);
        }
    }
    ...
    onPlayStepButton = function () {
        var graph = this.graph;
        graph.runStep(1);
        this.graphcanvas.draw(true, true);
    };

    onLiveButton = function () {
...
// LiteGraphJS.LiteGraph.Editor = Editor;
